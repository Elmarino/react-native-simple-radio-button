  ...
  _renderButton(obj, i) {
    return (
      <RadioButton
        ...
        borderColor={this.state.is_active_index === i ? this.props.selectedLabelColor : this.props.labelColor}
        labelStyle={this.props.labelStyle}
        style={this.props.radioStyle}
        animation={this.props.animation}
        disabled={this.props.disabled}
        firstRadio={this.props.firstRadio}
        onPress={(value, index) => {
  ...
  render () {
    ...
    renderContent = c ? (
      ...
      <View style={[
        ...
        {
          this.props.firstRadio ? <RadioButtonLabel {...this.props}
          accessibilityLabel={accessibilityLabel + 'Label' + accessibilityLabelIndex}
          testID={testID + 'Label' + testIDIndex} />:null
        }
